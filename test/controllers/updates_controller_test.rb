...
class UpdatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post updates_url, params: { update: { description: @update.description, name: @update.name } }
    end
  ...
  test "should update update" do
    patch update_url(@update), params: { update: { description: @update.description, name: @update.name } }
